...
best_score = """
	accuracy = 0.816 (+/-0.039) for {'n_neighbors': 9, 'weights': 'distance'}
	accuracy = 0.816 (+/-0.045) for {'n_neighbors': 11, 'weights': 'distance'}
	accuracy = 0.816 (+/-0.043) for {'n_neighbors': 16, 'weights': 'distance'}
	accuracy = 0.815 (+/-0.044) for {'n_neighbors': 19, 'weights': 'distance'}
	accuracy = 0.815 (+/-0.038) for {'n_neighbors': 8, 'weights': 'distance'}
	accuracy = 0.814 (+/-0.043) for {'n_neighbors': 12, 'weights': 'distance'}
	accuracy = 0.814 (+/-0.046) for {'n_neighbors': 15, 'weights': 'distance'}
	accuracy = 0.814 (+/-0.042) for {'n_neighbors': 18, 'weights': 'distance'}
	accuracy = 0.814 (+/-0.040) for {'n_neighbors': 10, 'weights': 'distance'}
	accuracy = 0.814 (+/-0.042) for {'n_neighbors': 14, 'weights': 'distance'}
"""
